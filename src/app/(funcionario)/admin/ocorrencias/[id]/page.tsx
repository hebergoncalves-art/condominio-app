...
} from "@/app/(morador)/morador/ocorrencias/_actions/occurrences";
...
export default async function StaffOccurrencePage({
  params,
}: {
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <DeleteOccurrenceButton id={item.id} redirectTo="/admin" />
          </div>
          <OccurrenceForm
            id={item.id}
            initial={item}
